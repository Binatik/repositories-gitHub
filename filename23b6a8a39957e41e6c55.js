...
;// CONCATENATED MODULE: ./src/scripts/repositories/renders.js
function autocomplited(functionTemplate, renderElement, renderData) {
  renderElement.innerHTML = "";
  renderData.forEach(function (repositorie) {
    return renderElement.insertAdjacentHTML("beforeend", functionTemplate(repositorie));
  });
}

;// CONCATENATED MODULE: ./src/scripts/repositories/templetes.js
function getAutocomplitedTemplate(element) {
  return "<button\n  data-Id=".concat(element.id, "\n  type=\"button\" \n  class=\"autocomplited__button \n  autocomplited__button--wide\">\n  ").concat(element.name, "</button>");
}
function getTodoTemplate(element) {
  return "<div class=\"todo__item\">\n  <p>\u0418\u043C\u044F \u0440\u0435\u043F\u043E\u0437\u0438\u0442\u043E\u0440\u0438\u044F ".concat(element.name, "</p>\n  <p>\u0412\u043B\u0430\u0434\u0435\u043B\u0435\u0446 ").concat(element.owner.login, "</p>\n  <p>\u0420\u0435\u0439\u0442\u0438\u043D\u0433 ").concat(element.stargazers_count, "</p>\n  <button data-id=").concat(element.id, " type=\"button\">\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0440\u0435\u043F\u043E\u0437\u0438\u0442\u043E\u0440\u0438\u0439</button>\n  </div>");
}

;// CONCATENATED MODULE: ./src/scripts/helpers.js
var debounce = function debounce(fn, debounceTime) {
  var timer;
  return function () {
    var _this = this;
...
;// CONCATENATED MODULE: ./src/scripts/repositories/index.js
...
function repositories() {
  var search = document.querySelector(".autocomplited__search");
  var autocomplitedList = document.querySelector(".autocomplited__list");
  ...
  search.addEventListener("input", debounce( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
      var value, getSearchData, request, data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            getSearchData = /*#__PURE__*/function () {
            ...
            request = "https://api.github.com/search/repositories?q=".concat(value, "&per_page=5");
            _context2.next = 6;
  ...
  todo.addEventListener("click", function (event) {
    var id = event.target.dataset.id;
    filterSearchState = filterSearchState.filter(function (item) {
      return item.id !== +id;
    });
    autocomplited(getTodoTemplate, todo, filterSearchState);
  });
